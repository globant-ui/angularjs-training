...
myApp.service('incomeService', function($http) {
 ...
 this.add_income = function() {
  ...
  if (this.temp_2.payer != "" && this.temp_2.payee != "" && this.temp_2.amount != "" && this.temp_2.type != "") {
   this.enter_income = false;
 ...
 this.add_expense = function() {
  ...
  if (this.temp.payer != "" && this.temp.payee != "" && this.temp.amount != "" && this.temp.date != "" && this.temp.category != "" && this.temp.payment != "") {
   this.enter_expense = false;
...
this.add_rec_expense = function() {
  ...
  if (this.temp_3.payer != "" && this.temp_3.payee != "" && this.temp_3.amount != "" && this.temp_3.date != "" && this.temp_3.category != "" && this.temp_3.payment != "" && this.temp_3.interval != "") {
   this.enter_rec_expense = false;
...
myApp.directive('expenseNotifications', function() {
  return {
   ...
   scope.delClick = function(index) {
      scope.rec_expenses.splice(index,1);
   }
}
  }});